...
var questions = [
	{
		"question": "How can you select all items in the inventory table that have a quantity between 10 and 50?",
	...
	{
		"question": "What SQL query retrieves all transactions that are not between the amounts of $100 and $500 from the transactions table?",
		"answer": "SELECT * FROM Transactions WHERE amount NOT BETWEEN 100 AND 500;"
	},
	{
		"question": "Write a query to find all orders in the orders table where the order_date is between January 1, 2023, and December 31, 2023.",
		"answer": "SELECT * FROM Orders WHERE order_date BETWEEN '2023-01-01' AND '2023-12-31';"
	},
	{
		"question": "Write a query to find all customers in the customers table whose customer_id is not between 5 and 15.",
		"answer": "SELECT * FROM Customers WHERE customer_id NOT BETWEEN 5 AND 15;"
	},
	{
		"question": "Write a SQL query to select customer_id from the customers table and alias it as ID.",
		"answer": "SELECT customer_id AS ID FROM Customers;"
	}
]
...
func show_hint_result(answer: String) -> String:
	match answer:
		"SELECT * FROM Inventory WHERE quantity BETWEEN 10 AND 50;":
			return "Hint: Use 'BETWEEN' to filter a range of values in the inventory."
		"SELECT employee_name FROM Employees WHERE employee_name LIKE '%an%';":
			return "Hint: Use 'LIKE' with '%' to match substrings in a name."
		"SELECT * FROM Transactions WHERE amount NOT BETWEEN 100 AND 500;":
			return "Hint: Use 'NOT BETWEEN' to exclude transactions within a range."
		"SELECT * FROM Orders WHERE order_date BETWEEN '2023-01-01' AND '2023-12-31';":
			return "Hint: Use 'BETWEEN' with date values to filter a range of order dates."
		"SELECT * FROM Customers WHERE customer_id NOT BETWEEN 5 AND 15;":
			return "Hint: Use 'NOT BETWEEN' to exclude specific ID ranges."
		"SELECT customer_id AS ID FROM Customers;":
			return "Hint: Use 'AS' to alias the column name."
		_:
