...
var questions = [
	...
	{
		"question": "How can you update the price of a product in the 'Products' table where product_id = 1 to 1150.00?",
		"answer": "UPDATE Products SET price = 1150.00 WHERE product_id = 1;"
	},
	{
...
func show_hint_result(answer: String) -> String:
	match answer:
		...
		"UPDATE Users SET status = 'Active';":
			return "Hint: Use 'UPDATE' without a 'WHERE' clause to change all rows."
		"UPDATE Products SET price = 1150.00 WHERE product_id = 1;":
			return "Hint: Use 'UPDATE' and 'SET' to change the value, with a 'WHERE' clause to target the product."
		"UPDATE Employees SET first_name = 'Jane', last_name = 'Gomez' WHERE employee_id = 3;":
			return "Hint: Use 'UPDATE' to modify multiple columns with a single query, and use 'WHERE' to target the employee."
		"UPDATE Employees SET salary = 55000 WHERE employee_id = 10;":
			return "Hint: Use 'UPDATE' and 'SET' to modify the salary, and 'WHERE' to specify the employee."
		_:
